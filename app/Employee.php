...
class Employee extends Model
{
    ...
    public function get_net_salary()
    {
        ...
        $employee       = Employee::where('employee_id', '=', $this->id)->first();
    ...
    public function yearly_bonuses()
    {
        return $this->hasMany('App\YearlyBonus');
    }

    public function loan_customs()
    {
        return $this->hasMany('App\LoanCustom');
    }
}
