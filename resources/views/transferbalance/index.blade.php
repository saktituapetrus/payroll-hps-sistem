                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped mb-0" id="dataTable">
                                        ...
                                        @foreach ($transferbalances as $transferbalance)
                                            <tr>
                                                <td>{{ $transferbalance->account($transferbalance->from_account_id)->account_name }}</td>
                                                <td>{{ $transferbalance->account($transferbalance->to_account_id)->account_name }}</td>
                                                <td>{{  \Auth::user()->dateFormat($transferbalance->date) }}</td>
                                                <td>{{  \Auth::user()->priceFormat($transferbalance->amount) }}</td>
                                                <td>{{ $transferbalance->payment_type($transferbalance->payment_type_id)->name }}</td>
